    ...
    <section class="content">
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%; background-color: #EEF2CE; color: #057d2d">
           <div class="box-header" style="margin-top : 10px; border-bottom: 2px solid #057d2d; color: #057d2d">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <input type="text" name="id_transaksi" style="margin-left:37px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=random_string('alpha', 2);?>-<?=date("Y");?><?=random_string('numeric', 8);?>">
                </div>
                <div class="form-group">
            ...
            <div class="form-group" style="display:inline-block;">
              <button type="reset" class="btn btn-primary" name="btn_reset" style="width:95px;margin-left:-70px;"><i class="fa fa-eraser" aria-hidden="true"></i> Reset</button>
            </div>
              <!-- /.box-body -->
              <div class="box-footer" style="width:93%; background-color: #EEF2CE">
                <a type="button" class="btn btn-danger" style="width:10%;margin-right:26%" onclick="history.back(-1)" name="btn_kembali"><i class="fa fa-arrow-left" aria-hidden="true"></i> Kembali</a>
                <a type="button" class="btn btn-info" style="width:14%;margin-right:29%" href="<?=base_url('Pejabat/tabel_barangmasuk')?>" name="btn_listbarang"><i class="fa fa-table" aria-hidden="true"></i> Lihat List Barang</a>
                <button type="submit" style="width:20%" class="btn btn-warning"><i class="fa fa-check" aria-hidden="true"></i> Submit</button>
              </div>
            </form>
          </div>
          </div>
