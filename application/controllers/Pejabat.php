...
public function sigout(){
  ...
  public function proses_new_password()
  {
    ...
    if($this->form_validation->run() == TRUE)
    {
      if($this->session->userdata('token_generate') === $this->input->post('token'))
      {
        ...
        redirect(base_url('Pejabat/setting'));
      }
    }else {
  ...
  public function tabel_barangmasuk()
  {
    ...
    $this->load->view('Pejabat/tabel/tabel_barangmasuk',$data);
  }
    public function barang_disetujui()
  {
    ...
    $this->load->view('Pejabat/tabel/tabel_barangpersetujuan',$data);
  }
  ...
  public function update_barang($id_transaksi)
  {
    ...
    $data['list_satuan'] = $this->M_Pejabat->select('tb_satuan');
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/form_barangmasuk/form_update',$data);
  }
  ...
  public function barang_keluar()
  {
    ...
    $data['list_satuan'] = $this->M_Pejabat->select('tb_satuan');
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/perpindahan_barang/form_keluarkan',$data);
  }
  ...
  public function proses_persetujuan_data()
  {
    ...
    if($this->form_validation->run() === TRUE)
    {
      ...
      $data = array(
        ...
        redirect(base_url('Pejabat/tabel_barangkeluar'));
    }else {
      $this->load->view('tabel/tabel_barangpersetujuan/'.$id_transaksi);
    }
  ...
  public function tabel_barangkeluar()
  {
    ...
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/tabel/tabel_barangkeluar',$data);
  }
}
?>