...
class Pejabat extends CI_Controller{
  ...
  public function index(){
    if($this->session->userdata('status') == 'login' && $this->session->userdata('role') == 2){
      ...
      $data['dataUser'] = $this->M_Pejabat->numrows('user');
      $this->load->view('Pejabat/indexnew',$data);
    }else {
  ...
  public function profile()
  {
    ...
    $this->load->view('Pejabat/profilenew',$data);
  }
  ...
  public function proses_new_password()
  {
    ...
    if($this->form_validation->run() == TRUE)
    {
      if($this->session->userdata('token_generate') === $this->input->post('token'))
      {
        ...
        $this->M_Pejabat->update_password('user',$where,$data);

        $this->session->set_flashdata('msg_berhasil','Password Telah Diganti');
        redirect(base_url('Pejabat/profile'));
      }
    }else {
      $this->load->view('Pejabat/profile');
    }
  }
  ...
  public function proses_gambar_upload()
  {
    $config =  array(
      ...
      if( ! $this->upload->do_upload('userpicture'))
      {
        ...
        $this->M_Pejabat->update('tb_upload_gambar_user',$data,$where);
  ...
  {
    $data['list_users'] = $this->M_Pejabat->kecuali('user',$this->session->userdata('name'));
    $data['token_generate'] = $this->token_generate();
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->session->set_userdata($data);
    $this->load->view('Pejabat/usersnew',$data);
  }

  public function form_user()
  {
    $data['list_satuan'] = $this->M_Pejabat->select('tb_satuan');
    $data['token_generate'] = $this->token_generate();
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->session->set_userdata($data);
    $this->load->view('Pejabat/form_users/form_insert_new',$data);
  }
  ...
  public function update_user()
  {
    ...
    $where = array('id' => $id);
    $data['token_generate'] = $this->token_generate();
    $data['list_data'] = $this->M_Pejabat->get_data('user',$where);
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->session->set_userdata($data);
    $this->load->view('Pejabat/form_users/form_update',$data);
  }
  ...
  public function proses_delete_user()
  {
    $id = $this->uri->segment(3);
    $where = array('id' => $id);
    $this->M_Pejabat->delete('user',$where);
    $this->session->set_flashdata('msg_berhasil','User Behasil Di Delete');
    redirect(base_url('Pejabat/users'));
  ...
  public function proses_tambah_user()
  {
    ...
    if($this->form_validation->run() == TRUE)
    {
      if($this->session->userdata('token_generate') === $this->input->post('token'))
      {
        ...
        $this->M_Pejabat->insert('user',$data);

        $this->session->set_flashdata('msg_berhasil','User Berhasil Ditambahkan');
        redirect(base_url('Pejabat/form_user'));
        }
      }else {
        $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
        $this->load->view('Pejabat/form_users/form_insert',$data);
    }
  }
  ...
  public function proses_update_user()
  {
    ...
    if($this->form_validation->run() == TRUE)
    {
      if($this->session->userdata('token_generate') === $this->input->post('token'))
      {
        ...
        $this->M_Pejabat->update('user',$data,$where);
        $this->session->set_flashdata('msg_berhasil','Data User Berhasil Diupdate');
        redirect(base_url('Pejabat/users'));
       }
    }else{
        $this->load->view('Pejabat/form_users/form_update');
    }
  }
  ...
  public function form_barangmasuk()
  {
    $data['list_satuan'] = $this->M_Pejabat->select('tb_satuan');
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/form_barangmasuk/form_insert_new',$data);
  }

  public function tabel_barangmasuk()
  {
    $data = array(
              'list_data' => $this->M_Pejabat->select('tb_barang_masuk'),
  ...
  public function update_barang($id_transaksi)
  {
    ...
    $data['data_barang_update'] = $this->M_Pejabat->get_data('tb_barang_masuk',$where);
    $data['list_satuan'] = $this->M_Pejabat->select('tb_satuan');
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/form_barangmasuk/form_update_new',$data);
  }
  ...
  public function proses_databarang_masuk_insert()
  {
    ...
    if($this->form_validation->run() == TRUE)
    {
      ...
      $this->M_Pejabat->insert('tb_barang_masuk',$data);

      $this->session->set_flashdata('msg_berhasil','Data Barang Berhasil Ditambahkan');
      redirect(base_url('Pejabat/form_barangmasuk'));
    }else {
      $data['list_satuan'] = $this->M_Pejabat->select('tb_satuan');
      $this->load->view('Pejabat/form_barangmasuk/form_insert',$data);
    }
  }
  ...
  {
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/form_satuan/form_insert_new',$data);
  }

  public function tabel_satuan()
  {
    $data['list_data'] = $this->M_Pejabat->select('tb_satuan');
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/tabel/tabel_satuan_new',$data);
  }
  ...
  public function update_satuan()
  {
    ...
    $data['data_satuan'] = $this->M_Pejabat->get_data('tb_satuan',$where);
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/form_satuan/form_update_new',$data);
  }
  ...
  public function delete_satuan()
  {
    $uri = $this->uri->segment(3);
    $where = array('id_satuan' => $uri);
    $this->M_Pejabat->delete('tb_satuan',$where);
    redirect(base_url('Pejabat/tabel_satuan'));
  }
  ...
  public function proses_satuan_insert()
  {
    ...
    if($this->form_validation->run() ==  TRUE)
    {
      ...
      $this->M_Pejabat->insert('tb_satuan',$data);

      $this->session->set_flashdata('msg_berhasil','Data satuan Berhasil Ditambahkan');
      redirect(base_url('Pejabat/form_satuan'));
    }else {
      $this->load->view('Pejabat/form_satuan/form_insert');
    }
  }
  ...
  public function proses_satuan_update()
  {
    ...
    if($this->form_validation->run() ==  TRUE)
    {
      ...
      $this->M_Pejabat->update('tb_satuan',$data,$where);

      $this->session->set_flashdata('msg_berhasil','Data satuan Berhasil Di Update');
      redirect(base_url('Pejabat/tabel_satuan'));
    }else {
      $this->load->view('Pejabat/form_satuan/form_update');
    }
  }
  ...
  public function barang_keluar()
  {
    ...
    $data['list_data'] = $this->M_Pejabat->get_data('tb_barang_masuk',$where);
    $data['list_satuan'] = $this->M_Pejabat->select('tb_satuan');
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/perpindahan_barang/form_update_new',$data);
  }
  ...
  {
    $data['list_data'] = $this->M_Pejabat->select('tb_barang_keluar');
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/tabel/tabel_barangkeluar_new',$data);
  }
   ####################################
        // DATA BARANG KELUAR
  ####################################
  ...
  {
    $data['list_data'] = $this->M_Pejabat->select('tb_barang');
    $this->load->view('Pejabat/tabel/tabel_barang',$data);
  }
public function form_barang()
  {
    $data['avatar'] = $this->M_Pejabat->get_data_gambar('tb_upload_gambar_user',$this->session->userdata('name'));
    $this->load->view('Pejabat/form_barang/form_insert',$data);
  }
 public function proses_barang_insert()
  {
    ...
    if($this->form_validation->run() ==  TRUE)
    {
      ...
      $this->M_Pejabat->insert('tb_barang',$data);

      $this->session->set_flashdata('msg_berhasil','Data Jenis Barang Berhasil Ditambahkan');
      redirect(base_url('Pejabat/form_barang'));
    }else {
      $this->load->view('Pejabat/form_barang/form_insert');
    }
  }
  public function update_barang1()
  {
    $uri = $this->uri->segment(3);
    $where = array('Id_barang' => $uri);
    $data['data_barang'] = $this->M_Pejabat->get_data('tb_barang',$where);
    $this->load->view('Pejabat/form_barang/form_update',$data);
  }
   public function proses_barang_update()
  {
    ...
    if($this->form_validation->run() ==  TRUE)
    {
      ...
      $this->M_Pejabat->update('tb_barang',$data,$where);

      $this->session->set_flashdata('msg_berhasil','Data Jenis barang Berhasil Di Update');
      redirect(base_url('Pejabat/tabel_barang'));
    }else {
      $this->load->view('Pejabat/form_barang/form_update');
    }
}
  public function delete_barang1()
  {
    $uri = $this->uri->segment(3);
    $where = array('Id_barang' => $uri);
