...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 11 Jun 2021 pada 13.07
...
--
-- Struktur dari tabel `tb_barang_persetujuan`
--

CREATE TABLE `tb_barang_persetujuan` (
  `id` int(10) NOT NULL,
  `id_transaksi` varchar(50) NOT NULL,
  `tanggal_masuk` varchar(20) NOT NULL,
  `tanggal_keluar` varchar(20) NOT NULL,
...
--
-- Dumping data untuk tabel `tb_barang_persetujuan`
--

INSERT INTO `tb_barang_persetujuan` (`id`, `id_transaksi`, `tanggal_masuk`, `tanggal_keluar`, `lokasi`, `kode_barang`, `nama_barang`, `satuan`, `jumlah`) VALUES
(1, 'WG-201713067948', '8/11/2017', '11/11/2017', 'NTB', '8888166995215', 'Ciki Walens', 'Dus', '50'),
(2, 'WG-201713067948', '8/11/2017', '11/12/2017', 'NTB', '8888166995215', 'Ciki Walens', 'Dus', '6'),
(3, 'WG-201713549728', '4/11/2017', '11/11/2017', 'Banten', '1923081008002', 'Buku Hiragana', 'Pack', '3'),
(4, 'WG-201774896520', '9/11/2017', '12/11/2017', 'Yogyakarta', '60201311121008264', 'Battery ZTE', 'Dus', '3'),
...
(20, 'admin', 'admin@gmail.com', '$2y$10$3HNkMOtwX8X88Xb3DIveYuhXScTnJ9m16/rPDF1/VTa/VTisxVZ4i', 1, '11-06-2021 10:43'),
(22, 'pejabat', 'ewin@admin.com', '$2y$10$7h/3H2GBkyKUONt6FI.Qzeg.rfjDVaIq5rQ60it30hCrrLYROmAkO', 2, '11-06-2021 12:39'),
(23, 'eric', 'eric@admin.com', '$2y$10$ZVKZxsAy8wjOmbMJrFp.9.5AYVJvS4KKvA5T3dv5yrGobX9Qh0SQm', 2, '11-06-2021 10:43');
...
--
-- Indeks untuk tabel `tb_barang_persetujuan`
--
ALTER TABLE `tb_barang_persetujuan`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT untuk tabel `tb_barang_persetujuan`
--
ALTER TABLE `tb_barang_persetujuan`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
